...
@Component({
  selector: 'app-chat-customer-potential',
  templateUrl: './chat-customer-potential.component.html',
  styleUrls: ['./chat-customer-potential.component.css']
})
export class ChatCustomerPotentialComponent extends OrderDataComponent implements OnInit {
