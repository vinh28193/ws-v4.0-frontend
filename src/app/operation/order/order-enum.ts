...
export const StatusOrder = [
  ...
  // {id: 7, key: 'seller_shipped', name: 'SELLER_SHIPPED'},
  // {id: 8, key: 'stockin_us', name: 'STOCK_IN_US'},
  // {id: 9, key: 'stockout_us', name: 'STOCK_OUT_US'},
  // {id: 10, key: 'stockin_local', name: 'STOCK_IN_LOCAL'},
  // {id: 11, key: 'stockout_local', name: 'STICK_OUT_LOCAL'},
  // {id: 12, key: 'at_customer', name: 'AT_CUSTOMER'},
  {id: 1, key: 'awaiting_payment', name: 'RETURNED'},
  {id: 2, key: 'ready_purchase', name: 'READY2PURCHASE'},
  {id: 3, key: 'purchasing', name: 'PURCHASING'},
  {id: 4, key: 'awaiting_confirm_purchase', name: 'AWAITING CONFIRM PURCHASE'},
  {id: 5, key: 'delivering', name: 'DELIVERING'},
  {id: 6, key: 'delivered', name: 'DELIVERED'},
  {id: 7, key: 'returned', name: 'RETURNED'},
